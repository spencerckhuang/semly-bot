...
def test_before_check_in(monday: datetime):
    assert is_30_minutes_before_check_in(monday - timedelta(minutes=30)) is True


def test_not_before_check_in(monday: datetime):
    assert is_30_minutes_before_check_in(monday + timedelta(minutes=30)) is False
    assert is_30_minutes_before_check_in(monday - timedelta(minutes=31)) is False
    assert is_30_minutes_before_check_in(monday - timedelta(minutes=29)) is False
...
def test_before_hack_session(thursday: datetime):
    assert is_30_minutes_before_hack_session(thursday - timedelta(minutes=30)) is True


def test_not_before_hack_session(thursday: datetime):
    assert is_30_minutes_before_hack_session(thursday + timedelta(minutes=30)) is False
    assert is_30_minutes_before_hack_session(thursday - timedelta(minutes=31)) is False
    assert is_30_minutes_before_hack_session(thursday - timedelta(minutes=29)) is False
...
def test_not_hack_session(thursday: datetime):
    ...
    assert is_hack_session_time(thursday - timedelta(minutes=1)) is False
    assert is_hack_session_time(thursday - timedelta(minutes=30)) is False
